...
---------------MC------------------
			...
			["18832"] = {"L3，獵人盜賊狂戰不可貪婪; 獵人=狂戰=盜賊", 1 },	--殘忍利刃
			["18805"] = {"L3，盜賊獵人狂戰不可貪婪; 匕賊>獵人=劍賊=狂戰", 1 },	--熔火犬牙
			["18816"] = {"L3，盜賊不可貪婪; 匕賊要被強X; 匕賊>劍賊", 1 },	--毀滅之刃
...
---------------黑龍-----------------------
			...
			["17075"] = {"L3，狂戰盜賊不可貪婪; 狂戰=劍賊>匕賊=防戰", 0 },	--放血者維斯卡格
---------------BWL------------------
			["19371"] = {"L1，補師不可貪婪; 補薩>牧師=補德>法師=術士", 0 },	--龍魂墜飾
			["19377"] = {"L3，盜賊獵人不可貪婪,要被強X; 盜賊=獵人>補德=防戰", 0 },	--普瑞斯托的陰謀飾物
			["19398"] = {"L1，盜賊獵人不可貪婪; 盜賊無[環霧/飛龍]要被強X; 盜賊>獵人=防戰", 0 },	--火喉披風
			["19430"] = {"L3，全補師不可貪婪,要被強X; 全補師平權", 0 },	--純淨思維披風
			["19436"] = {"L1，狂戰盜賊不可貪婪; 狂戰要被強X; 狂戰>盜賊=防戰>補德=補薩", 0 },	--飛龍披風
			["19386"] = {"L1，防戰不可貪婪,要被強X; 防戰>補德", 0 },	--源質絲線披風
			["19378"] = {"L3，法師術士不可貪婪,無[吞噬披風]要被強X; 法師=術士>其他補師", 0 },	--龍王披風
			["19434"] = {"L1，術士不可貪婪,要被強X; 術士>牧師", 0 },	--龍類統御之戒
			["19397"] = {"L1，法師術士補薩不可貪婪; 補薩最優先,其他平權", 0 },	--黑石之戒
			["19403"] = {"L3，法師術士不可貪婪,要被強X; 法師=術士", 0 },	--專注指環
			["19432"] = {"L1，獵人不可貪婪; 盜賊>防戰=補德", 0 },	--源力之環
			["19376"] = {"L3，盜賊獵人不可貪婪; 盜賊>防戰=補德", 0 },	--阿基迪羅斯的清算之戒
			...
			["19406"] = {"L3，盜賊戰士獵人不可貪婪; 盜賊狂戰獵人要被強X; 盜賊=狂戰>防戰=獵人", 1 },	--龍牙飾物
			...
			["19396"] = {"L1，可以貪婪; 盜賊>補德", 0 },	--緊繃龍皮腰帶
			["19405"] = {"L1，可以貪婪; 補德最優先", 0 },	--瑪法里恩的祝福
			["19389"] = {"L1，可以貪婪; 盜賊=補德", 0 },	--緊繃龍皮護肩
			["19390"] = {"L1，可以貪婪; 補薩=補德", 0 },	--緊繃龍皮手套
			["19381"] = {"L3，盜賊不可貪婪,要被強X; 盜賊>補德=補薩=防戰", 1 },	--暗影烈焰長靴
			...
			["19358"] = {"L1，狂戰不可貪婪; 狂戰>防戰=補薩=補德", 0 },	--龍人之槌
			["19335"] = {"L1，防戰不可貪婪; 防戰>盜賊", 0 },	--碎脊者
			["19334"] = {"L1，狂戰不可貪婪; 狂戰=防戰", 0 },	--狂野之刃
			["19346"] = {"L1，盜賊獵人不可貪婪; 匕賊無[狗牙/無面]要被強X; 匕賊>劍賊=防戰=獵人", 0 },	--龍牙之刃
			["19351"] = {"L3，盜賊狂戰不可貪婪; 劍賊要被強X; 劍賊>匕賊=防戰", 0 },	--瑪拉達斯，黑龍軍團的符文之劍
			["19365"] = {"L1，狂戰不可貪婪; 狂戰>盜賊=防戰", 0 },	--黑龍之爪
			["19353"] = {"L1，狂戰不可貪婪; 狂戰>防戰=補薩", 0 },	--龍爪巨斧
			["19355"] = {"L1，法師術士補師可以貪婪; 法師=術士=補薩=補德>牧師", 0 },	--暗影之翼
			["19357"] = {"L1，可以貪婪; ", 0 },	--悲哀使者
			["19347"] = {"L3，法師術士補薩補德不可貪婪; 法師術士無[碧空/SSF]要被強X; 法師=術士=補薩=補德>牧師", 0 },	--克洛瑪古斯之爪
			["19352"] = {"L3，盜賊狂戰不可貪婪; 劍賊要被強X; 劍賊>匕賊=防戰", 0 },	--多彩之劍
			["19360"] = {"L3，全補師不可貪婪; 補薩補德無[狗爪]要被強X; 補薩=補德>牧師", 0 },	--洛卡米爾·伊洛曼希斯
			...
			["19002"] = {"L1，戰士盜賊法師術士不可貪婪; 防戰要被強X; 防戰>狂戰=盜賊=法師=術士>全補師;獵人NA", 0 },	--奈法利安的頭顱
---------------BWL職業飾品------------------
			["19341"] = {"", 0 }, 	-- [生命寶石]
			["19342"] = {"", 0 }, 	-- [毒性圖騰]
			["19336"] = {"", 0 }, 	-- [秘法能量寶石]
